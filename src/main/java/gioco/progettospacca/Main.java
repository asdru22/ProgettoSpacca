...
import gioco.progettospacca.classi.Amministratore;
...
public class Main {
    public static void main(String[] args) {
        ...
        Giocatore[] giocatori = aggiungiGiocatori();
        int id_temp = scriviPartita(giocatori);
        //
        //
        Partita partita =leggiPartita(gson,id_temp);
    ...
    public static int scriviPartita(Giocatore[] giocatori){
    ...
    public static String leggiFileJson(String nomeFile) {
        try {
    ...
    public static Giocatore[] aggiungiGiocatori(){
    ...
    public static Partita leggiPartita(Gson gson,int id){
        ...
        for (Giocatore giocatore : partita.getGiocatori()) System.out.println(giocatore);
        return partita;
    }
    public static void autenticazione(Gson gson){
